...
export default function Buttonstyle({ text }: Buttonstyle) {
  return (
    <button
      className="w-60 h-20 tracking-widest inline-flex justify-center text-2xl spac
  items-center gap-x-4 p-4 text-black bg-white z-[1]
 ...
 before:ease-out
 before:w-0 before:h-0 hover:before:w-60 hover:before:h-2/4 
 hover:before:transition-all
 after:absolute after:bottom-0 after:left-0 after:right-0 
 after:h-0 after:w-0
 after:bg-black   hover:after:h-2/4 hover:after:w-60 
 after:duration-500 
